...
import (
	...
	"github.com/linkflow-ai/linkflow-ai/internal/schedule/server"
)

func main() {
	// Initialize configuration
	cfg, err := config.Load("schedule")
	if err != nil {
	...
	log.Info("Starting Schedule Service", "version", cfg.Version, "port", cfg.HTTP.Port)
	...
	log.Info("Schedule Service stopped gracefully")
}
