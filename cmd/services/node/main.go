...
import (
	...
	"github.com/linkflow-ai/linkflow-ai/internal/node/server"
...
func main() {
	...
	log.Info("Starting Node Service", "version", cfg.Version, "port", cfg.HTTP.Port)
	...
	log.Info("Node Service stopped gracefully")
}
